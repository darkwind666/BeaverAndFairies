...
public class FirebaseAnalyticsDeps : AssetPostprocessor
{
    ...
    static void SetupDeps()
    {
        ...
        Google.VersionHandler.InvokeInstanceMethod(svcSupport, "DependOn", new object[] { "com.google.firebase", "firebase-analytics-unity", "1.1.2" }, namedArgs: new Dictionary<string, object>() { { "packageIds", null }, { "repositories", new string[] { "Assets/Firebase/m2repository" } } });
#elif UNITY_IOS
